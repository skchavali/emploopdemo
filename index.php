...
$sql = "SELECT customer_id, first_name, last_name FROM customer WHERE customer_id = $aid";
...
echo "List of Customers added to system recently";
...
$sql = "SELECT customer_id, first_name, last_name FROM customer ORDER BY last_update desc LIMIT 5";
if (!$result = $mysqli->query($sql)) {
    echo "Sorry, the website is experiencing problems.";
    exit;
}
...
while ($actor = $result->fetch_assoc()) {
    echo "<li><a href='" . 'index.php' . "?aid=" . $actor['customer_id'] . "'>\n";
